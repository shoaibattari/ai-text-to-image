...
export default function ImageGenerator() {
  ...
  return (
    <>
      <div>
        <h5 className="mb-2 text-md md:text-3xl font-bold text-gray-900 dark:text-white ">
          Next Gen Image Generator
        </h5>
        <p className="mb-5 text-base text-gray-500 sm:text-1xl dark:text-gray-400">
      ...
      <div className="md:grid grid-cols-1 md:grid-cols-2 justify-center mt-5 ">
        {images.map((image) => (
          <div key={image} className="p-4 hover:scale-105 ">
            <Link href={image} target="blank">
              <Image src={image} alt="Image" width={450} height={200} />
            </Link>
          </div>
        ))}{" "}
      </div>
